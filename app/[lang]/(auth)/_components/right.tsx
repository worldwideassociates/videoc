  ...
  return (
    <div className="relative hidden h-full flex-col p-10 text-white lg:flex dark:border-r">
      <div className="absolute inset-0">
        <Image src={headerImage} alt="Header Image" layout="fill" objectFit="cover" className='bg-black' />
      </div>
      <div className="relative z-20 flex items-centerfont-medium text-black text-2xl font-bold">WWA</div>
